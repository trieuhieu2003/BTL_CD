...
<head>
    ...
    <title>IMS Homepage - He Thong Quan Ly Kho</title>
...
<body>
    ...
    <div class="banner">
        <div class="homepageContainer">
            ...
            <p class="bannerTagline">
                Kiểm soát toàn diện hành trình của từng sản phẩm - từ những bước đầu tiên chọn lựa nguồn hàng chất
                lượng, qua quy trình sản xuất tỉ mỉ, cho đến khi đến tay người tiêu dùng cuối cùng.
                Chúng tôi giúp bạn nắm bắt mọi khâu trong chuỗi cung ứng một cách hoàn hảo và chuyên nghiệp.
            </p>
            <div class="bannerIcons">
                <a href=""><i class="fab fa-apple" aria-hidden="true"></i></a>
                <a href=""><i class="fab fa-android" aria-hidden="true"></i></a>
                <a href=""><i class="fab fa-windows" aria-hidden="true"></i></a>
            </div>
        </div>
    </div>
    <div class="homepageContainer">
    ...
    <div class="homepageNotified">
        <div class="homepageContainer">
            <div class="homepageNotifiedContainer">
                ...
                <div class="video">
                    <iframe src="https://www.youtube.com/embed/KEFt2quibkg" frameborder="0" allowfullscreen
    ...
    <div class="socials">
        <div class="homepageContainer">
            ...
            <p class="socialText">Tôi ở đây để phục vụ các bạn, hãy liên hệ với chúng tôi</p>
